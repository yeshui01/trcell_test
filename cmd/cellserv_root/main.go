 ...
 * @LastEditTime: 2022-09-19 10:42:50
 * @FilePath: \trcell\cmd\cellserv_root\main.go
 */
package main
...
func main() {
	loghlp.Infof("cellserv_root main")
	...
	trframe.Init(cfgPath, trnode.ETRNodeTypeCellRoot, servIdx)
	servRoot := servroot.NewCellServRoot()
	trframe.RegisterUserFrameRun(func(curTimeMs int64) {
		servRoot.FrameRun(curTimeMs)
	})
