...
set TAR_CLIENT=%PROJECT_ROOT%\pkg\pb\
...
:: 客户端
::protoc --proto_path=%SRC_CLIENT% --go_out=%TAR_CLIENT%  %SRC_CLIENT%\c_base.proto
::protoc --proto_path=%SRC_CLIENT% --go_out=%TAR_CLIENT%  %SRC_CLIENT%\c_base_ext.proto
::protoc --proto_path=%SRC_CLIENT% --go_out=%TAR_CLIENT%  %SRC_CLIENT%\c_common.proto
::protoc --proto_path=%SRC_CLIENT% --go_out=%TAR_CLIENT%  %SRC_CLIENT%\c_player.proto
:: 换成新的路径
